<br/>
<h2 style="text-align:center;padding: 10px 0;color: white;background-color: rgb(86, 64, 158);">{{ __('Ajouter un atelier') }}</h2>
<div class="card-body">
    <form data-ajax-url="{{ route('ateliers.store') }}" data-ajax-success="CloseModal();Alert('success',xhr.responseText);AjaxFill('{{ route('ateliers.index') }}', '#app', false);" data-ajax="true" data-ajax-method="POST" data-ajax-failure="if(xhr.responseText.includes('The given data was invalid.')){ ShowErrors(xhr.responseText); } else{ Alert('error', 'Oups! Une erreur s\'est produite...'); }" data-ajax-begin="ClearErrors();" style="width:90%; max-width:500px; margin:auto; margin-bottom:45px;">
        @csrf
       ...
       <div class="form-group row">
        ...
        <div class="form-group row">
                ...
                <textarea id="summary-ckeditor" name="description" type="text" class="form-control"></textarea>
        ...
        <div class="form-group row">
            ...
            <input id="nomCompletResponsable" name="nomCompletResponsable" type="text" class="form-control" />
        ...
        <div class="form-group row">
            ...
            <textarea id="summary-ckeditor2" name="description_responsable" type="text" class="form-control"></textarea>
